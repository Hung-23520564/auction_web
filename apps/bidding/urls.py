...
from .views import place_bid, get_bids_for_item, get_highest_bid, cancel_my_bid_view, process_single_ended_auction
...
urlpatterns = [
    ...
    path('process-auction-end/',process_single_ended_auction, name='process_single_ended_auction'),
]
